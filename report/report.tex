...
\begin{itemize}
  ...
  \item Verschiedenste Coding-Guidelines werden eingesetzt und durch Pull-Request Reviews überprüft.
    \begin{itemize}
      ...
      \item Zur Formattierung wird Prettier verwendet.
      \item Es wird kein Pull-Request akzeptiert, falls die Überprüfung durch Eslint oder TSlint fehlschlägt oder der Code nicht korrekt formatiert ist. Dies wird automatisch von der Build-Pipeline überprüft.
    \end{itemize}
\end{itemize}
