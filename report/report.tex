...
Die detaillierte Konfiguration der Pipelines befindet sich in der Datei \textit{azure-pipeline.yml} des Code-Repositorys und in \href{https://dev.azure.com/schaumic/darwin/_build}{Azure DevOps}. Eine Kopie des Docker Compose Projekts befindet sich in \nameref{Anhang-A}.
...
Eine Kopie des Docker Compose Setups und der Nginx Konfiguration ist in \nameref{Anhang-A} ersichtlich.
