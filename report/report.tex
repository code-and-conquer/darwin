...
Ursprünglich war es die Idee das Spiel an die Legende um Willhelm Tell anzulehnen. Da aber keiner im Team Erfahrung 
im Bereich Grafik Design mitbringt, möchten wir das Theme des Spiels einfacher gestalten. Alle Objekte im Spiel 
möchten wir als geometrische Form darstellen, welche allenfalls kleine Modifikationen (zum Beispiel ein rotes Dreieck mit einem
