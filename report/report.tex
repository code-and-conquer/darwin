...
Da unser Projekt als zeitlich begrenztes Projekt einer Studenten-Gruppe läuft, ist keinerlei Support oder Maintenance nach Ablauf der Entwicklungsphase geplant. Auch eine Überwachungslösung ist nicht vorgesehen.
Serverseitig gibt es keine Logs. 

\subsection{Zugriff}
Der Zugriff auf die virtuelle Maschine erfolgt via SSH. Die IP-Adresse ist 160.85.252.31.
...
\begin{verbatim}
cd /web/darwin
sed -i 's/\*/file:.\/darwin-types/g' current/backend/package.json
