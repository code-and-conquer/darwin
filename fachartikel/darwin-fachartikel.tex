...
Mit Node.js können wir nicht nur im Frontend JavaScript einsetzen sondern ebenfalls im Backend. Dies ermöglicht es uns Code einfacher zwischen verschiedenen Teilen der Applikation auszutauschen. Zudem ist es die meistverwendete JavaScript Runtime \cite{node.js} und weist die notwendige Stabilität für das Projekt Darwin auf.
