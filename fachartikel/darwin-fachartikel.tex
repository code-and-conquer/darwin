...
\usepackage[style=ieee,backend=biber,alldates=edtf]{biblatex}
...
\printbibliography
%\begin{itemize}
%\item [2] P. D. Bhavsar. (30.1.2020). 7 Gründe für Node.js: Warum sich der Blick darauf lohnt [Online]. URL: https://entwickler.de/online/javascript/7-gruende-node-js-579924149.html [Stand 18.04.2020]
%\item [3] F. Copes. (8.1.2019). The React Handbook [online]. \\URL: https://www.freecodecamp.org/news/the-react-handbook-b71c27b0a795/ [Stand 18.04.2020]
%\item [4] Unknown author. (Unknown date). Lerna, A tool for managing JavaScript projects with multiple packages. [Online]. URL: https://lerna.js.org/ [Stand 18.04.2020]
%\end{itemize}
